...
class TrackHandler extends DirectorHandler {
	...
	function tracks() {
		...
		$templateMgr->assign('pageHierarchy', array(array(Request::url(null, null, 'director'), 'director.eventManagement')));
		$templateMgr->assign_by_ref('tracks', $tracks);
		$templateMgr->assign('helpTopicId','conference.managementPages.tracks');
		$templateMgr->display('director/tracks/tracks.tpl');
	}
	...
	function editTrack($args = array()) {
		...
		import('director.form.TrackForm');
