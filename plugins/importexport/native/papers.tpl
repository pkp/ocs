{**
 * plugins/importexport/native/papers.tpl
 *
...
{assign var="pageCrumbTitle" value="plugins.importexport.native.selectPaper"}
...
<div id="papers">
<form class="pkp_form" action="{plugin_url path="exportPapers"}" method="post" id="papers">
