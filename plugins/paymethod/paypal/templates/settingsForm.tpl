 ...
 *}
	...
	<tr>
		...
		<td class="value" width="80%"><input type="text" class="textField" name="paypalurl" id="paypalurl" size="50" value="{$paypalurl|escape}" /></td>
	</tr>
	<tr>
		...
		<td class="value" width="80%"><input type="text" class="textField" name="selleraccount" id="selleraccount" value="{$selleraccount|escape}" /></td>
	</tr>
	{if !$isCurlInstalled}
		<tr>
			<td colspan="2">
