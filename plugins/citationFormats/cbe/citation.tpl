...
{$paper->getDatePublished()|date_format:'%Y %b %e'}. {$paper->getLocalizedTitle()|strip_unsafe_html}. {$conference->getLocalizedName()|escape}. [{translate key="rt.captureCite.online"}]
</div>
