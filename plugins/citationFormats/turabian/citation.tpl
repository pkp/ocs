...
"{$paper->getPaperTitle()|strip_unsafe_html}" <i>{$conference->getConferenceTitle()|escape}</i> [{translate key="rt.captureCite.online"}],  ({$paper->getDatePublished()|date_format:'%e %B %Y'|trim})
