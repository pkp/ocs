...
<tr valign="top">
	...
	<td align="right" class="nowrap">
		{if $roleId}
		<a href="{url op="enroll" path=$roleId userId=$user->getUserId()}" class="action">{translate key="director.people.enroll"}</a>
		{else}
		<a href="javascript:enrollUser({$user->getUserId()})" class="action">{translate key="director.people.enroll"}</a>
		{/if}
