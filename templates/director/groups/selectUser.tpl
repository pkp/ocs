...
{assign var=pageTitle value="director.groups.membership.addMember"}
...
<tr valign="top">
	...
	<td>
		<a href="{url op="addMembership" path=$group->getGroupId()|to_array:$user->getUserId()}" class="action">{translate key="director.groups.membership.addMember"}</a>
	</td>
</tr>
...
{if $users->wasEmpty()}
	<tr>
	<td colspan="2" class="nodata">{translate key="director.groups.membership.noUsers"}</td>
	</tr>
