...
<p>{translate key="director.setup.conferenceHomepageHeaderDescription"}</p>

<h4>{translate key="director.setup.conferenceTitle"}</h4>

<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="homeHeaderTitleType" id="homeHeaderTitleType-0" value="0"{if not $homeHeaderTitleType} checked="checked"{/if} /> {fieldLabel name="homeHeaderTitleType-0" key="director.setup.useTextTitle"}</td>
	...
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="homeHeaderTitleType" id="homeHeaderTitleType-1" value="1"{if $homeHeaderTitleType} checked="checked"{/if} /> {fieldLabel name="homeHeaderTitleType-1" key="director.setup.useImageTitle"}</td>
...
<h4>{translate key="director.setup.conferenceLogo"}</h4>

<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label">{translate key="director.setup.useImageLogo"}</td>
...
{if $alternateLocale1}
<br />
<h4>{translate key="director.setup.conferenceTitle"} ({$languageToggleLocales.$alternateLocale1})</h4>

<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="homeHeaderTitleTypeAlt1" id="homeHeaderTitleTypeAlt1-0" value="0"{if not $homeHeaderTitleTypeAlt1} checked="checked"{/if} /> {fieldLabel name="homeHeaderTitleTypeAlt1-0" key="director.setup.useTextTitle"}</td>
	...
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="homeHeaderTitleTypeAlt1" id="homeHeaderTitleTypeAlt1-1" value="1"{if $homeHeaderTitleTypeAlt1} checked="checked"{/if} /> {fieldLabel name="homeHeaderTitleTypeAlt1-1" key="director.setup.useImageTitle"}</td>
...
{if $alternateLocale2}
<br />
<h4>{translate key="director.setup.conferenceTitle"} ({$languageToggleLocales.$alternateLocale2})</h4>

<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="homeHeaderTitleTypeAlt2" id="homeHeaderTitleTypeAlt2-0" value="0"{if not $homeHeaderTitleTypeAlt2} checked="checked"{/if} /> {fieldLabel name="homeHeaderTitleTypeAlt2-0" key="director.setup.useTextTitle"}</td>
	...
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="homeHeaderTitleTypeAlt2" id="homeHeaderTitleTypeAlt2-1" value="1"{if $homeHeaderTitleTypeAlt2} checked="checked"{/if} /> {fieldLabel name="homeHeaderTitleTypeAlt2-1" key="director.setup.useImageTitle"}</td>
...
<p>{translate key="director.setup.homepageImageDescription"}</p>

<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label">{translate key="director.setup.homepageImage"}</td>
...
<h3>5.3 {translate key="director.setup.conferencePageHeader"}</h3>

<p>{translate key="director.setup.conferencePageHeaderDescription"}</p>

<h4>{translate key="director.setup.conferenceTitle"}</h4>

<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="pageHeaderTitleType" id="pageHeaderTitleType-0" value="0"{if not $pageHeaderTitleType} checked="checked"{/if} /> {fieldLabel name="pageHeaderTitleType-0" key="director.setup.useTextTitle"}</td>
	...
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="pageHeaderTitleType" id="pageHeaderTitleType-1" value="1"{if $pageHeaderTitleType} checked="checked"{/if} /> {fieldLabel name="pageHeaderTitleType-1" key="director.setup.useImageTitle"}</td>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="pageHeaderTitleTypeAlt1" id="pageHeaderTitleTypeAlt1-0" value="0"{if not $pageHeaderTitleTypeAlt1} checked="checked"{/if} /> {fieldLabel name="pageHeaderTitleTypeAlt1-0" key="director.setup.useTextTitle"}</td>
	...
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="pageHeaderTitleTypeAlt1" id="pageHeaderTitleTypeAlt1-1" value="1"{if $pageHeaderTitleTypeAlt1} checked="checked"{/if} /> {fieldLabel name="pageHeaderTitleTypeAlt1-1" key="director.setup.useImageTitle"}</td>
...
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="pageHeaderTitleTypeAlt2" id="pageHeaderTitleTypeAlt2-0" value="0"{if not $pageHeaderTitleTypeAlt2} checked="checked"{/if} /> {fieldLabel name="pageHeaderTitleTypeAlt2-0" key="director.setup.useTextTitle"}</td>
	...
	<tr valign="top">
		<td width="20%" class="label"><input type="radio" name="pageHeaderTitleTypeAlt2" id="pageHeaderTitleTypeAlt2-1" value="1"{if $pageHeaderTitleTypeAlt2} checked="checked"{/if} /> {fieldLabel name="pageHeaderTitleTypeAlt2-1" key="director.setup.useImageTitle"}</td>
...
<h4>{translate key="director.setup.alternateHeader"}</h4>

<p>{translate key="director.setup.alternateHeaderDescription"}</p>
...
<h3>5.4 {translate key="director.setup.conferencePageFooter"}</h3>

<p>{translate key="director.setup.conferencePageFooterDescription"}</p>
...
<h3>5.5 {translate key="director.setup.navigationBar"}</h3>

<p>{translate key="director.setup.itemsDescription"}</p>

<table width="100%" class="data">
{foreach name=navItems from=$navItems key=navItemId item=navItem}
	<tr valign="top">
		<td width="20%" class="label">{fieldLabel name="navItems-$navItemId-name" key="director.setup.labelName"}</td>
		<td width="80%" class="value">
			...
			<table width="100%">
				<tr valign="top">
					...
					<td width="95%"><label for="navItems-{$navItemId}-isLiteral">{translate key="director.setup.navItemIsLiteral"}</label></td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td width="80%" class="value">
			...
			<table width="100%">
				<tr valign="top">
					...
					<td width="95%"><label for="navItems-{$navItemId}-isAbsolute">{translate key="director.setup.navItemIsAbsolute"}</label></td>
				</tr>
			</table>
		</td>
	</tr>
...
{foreachelse}
	<tr valign="top">
		<td width="20%" class="label">{fieldLabel name="navItems-0-name" key="director.setup.labelName"}</td>
		<td width="80%" class="value">
			...
			<table width="100%">
				<tr valign="top">
					...
					<td width="95%"><label for="navItems-0-isLiteral">{translate key="director.setup.navItemIsLiteral"}</label></td>
				</tr>
			</table>
		</td>
	</tr>
		...
		<td width="80%" class="value">
			...
			<table width="100%">
				<tr valign="top">
					...
					<td width="95%"><label for="navItems-0-isAbsolute">{translate key="director.setup.navItemIsAbsolute"}</label></td>
				</tr>
			</table>
		</td>
	</tr>
...
<p><input type="submit" name="addNavItem" value="{translate key="director.setup.addNavItem"}" class="button" /></p>


<div class="separator"></div>


<h3>5.6 {translate key="director.setup.conferenceStyleSheet"}</h3>

<p>{translate key="director.setup.conferenceStyleSheetDescription"}</p>
...
<h3>5.7 {translate key="director.setup.information"}</h3>

<p>{translate key="director.setup.information.description"}</p>

<h4>{translate key="director.setup.information.forReaders"}</h4>
...
<h3>5.8 {translate key="director.setup.lists"}</h3>
<p>{translate key="director.setup.listsDescription"}</p>
<table width="100%" class="data">
	<tr valign="top">
		<td width="20%" class="label">{translate key="director.setup.itemsPerPage"}</td>
		<td width="80%" class="value"><input type="text" size="3" name="itemsPerPage" class="textField" value="{$itemsPerPage|escape}" /></td>
	</tr>
	<tr valign="top">
		<td width="20%" class="label">{translate key="director.setup.numPageLinks"}</td>
