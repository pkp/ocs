...
<p><span class="instruct">{translate key="director.languages.languageInstructions"}</span></p>
...
<tr valign="top">
	<td>&nbsp;</td>
	<td colspan="2" class="value"><span class="instruct">{translate key="director.languages.primaryLocaleInstructions"}</span></td>
</tr>
<tr valign="top">
...
<tr valign="top">
	<td>&nbsp;</td>
	<td colspan="2" class="value"><span class="instruct">{translate key="director.languages.supportedLocalesInstructions"}</span></td>
</tr>
<tr valign="top">
	<td class="label">{fieldLabel name="alternateLocale1" key="director.languages.alternateLocale1"}</td>
...
<tr valign="top">
	<td class="label">{fieldLabel name="alternateLocale2" key="director.languages.alternateLocale2"}</td>
...
<tr valign="top">
	<td>&nbsp;</td>
	<td colspan="2" class="value"><span class="instruct">{translate key="director.languages.alternateLocaleInstructions"}</span></td>
</tr>
<tr valign="top">
	<td rowspan="2" class="label">{translate key="director.languages.alternativeLanguageOptions"}</td>
	<td width="5%"><input type="checkbox" name="conferenceTitleAltLanguages" id="conferenceTitleAltLanguages" value="1" /></td>
	<td width="75%"><label for="conferenceTitleAltLanguages">{translate key="director.languages.conferenceTitleAltLanguages"}</label></td>
</tr>
<tr valign="top">
	<td><input type="checkbox" name="paperAltLanguages" id="paperAltLanguages" value="1" /></td>
	<td><label for="paperAltLanguages">{translate key="director.languages.paperAltLanguages"}</label></td>
</tr>
</table>

<p><input type="submit" value="{translate key="common.save"}" class="button defaultButton" /> <input type="button" value="{translate key="common.cancel"}" class="button" onclick="document.location.href='{url page="director"}'" /></p>
...
<p><span class="instruct">{translate key="director.languages.noneAvailable"}</span></p>
{/if}
