...
<table width="100%" class="listing">
	...
	<tr valign="top">
		...
		<td><a href="{url op="submission" path=$submission->getPaperId()}" class="action">{$submission->getLocalizedTitle()|default:$untitledPaper|strip_tags|truncate:60:"..."|default:"&nbsp;"}</a>
