...
<a name="statistics"></a>
<h3>{translate key="director.statistics.reports"}</h3>
<p>{translate key="director.statistics.reports.description"}</p>

<form method="post" action="{url op="reportGenerator"}">
<table width="100%" class="data">
	<tr valign="top">
		<td width="25%" class="label">{translate key="director.statistics.reports.reportType"}</td>
