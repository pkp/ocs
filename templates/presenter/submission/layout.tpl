...
<table width="100%" class="info">
	...
	<tr>
		...
		<td width="35%">{$galley->getLabel()|escape} &nbsp; <a href="{url op="proofGalley" path=$submission->getPaperId()|to_array:$galley->getGalleyId()}" class="action">{translate key="submission.layout.viewProof"}</td>
