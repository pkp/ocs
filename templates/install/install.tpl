...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td class="label">{fieldLabel name="adminPassword2" key="user.account.repeatPassword"}</td>
...
<p><input type="submit" value="{translate key="installer.installOCS"}" class="button defaultButton" /> <input type="submit" name="manualInstall" value="{translate key="installer.manualInstall"}" class="button" /></p>
