...
{/if}
<tr valign="top">
	<td class="label">{fieldLabel name="policy" key="director.tracks.policy"}</td>
...
<tr valign="top">
	<td class="value">
		{fieldLabel name="identifyType" key="director.tracks.identifyType"} <input type="text" name="identifyType" id="identifyType" value="{$identifyType|escape}" size="20" maxlength="60" class="textField" />
		<br />
		<span class="instruct">{translate key="director.tracks.identifyTypeExamples"}</span>
	</td>
</tr>
<tr valign="top">
	...
	<td class="value">
		...
		{fieldLabel name="editorRestriction" key="director.tracks.editorRestriction"}
	</td>
</tr>
<tr valign="top">
...
<tr valign="top">
	<td width="20%">&nbsp;</td>
	<td>{translate key="director.tracks.unassigned"}</td>
	<td>&nbsp;</td>
	<td>{translate key="director.tracks.assigned"}</td>
</tr>
<tr valign="top">
	<td width="20%">&nbsp;</td>
	...
	<td><input type="button" value="{translate key="director.tracks.assignEditor"} &gt;&gt;" onclick="moveSelectItem(this.form.unassigned, this.form.assigned)" class="button" />
		<br /><br />
		<input type="button" value="&lt;&lt; {translate key="director.tracks.unassignEditor"}" onclick="moveSelectItem(this.form.assigned, this.form.unassigned)" class="button" /></td>
...
<p><input type="submit" value="{translate key="common.save"}" class="button defaultButton" /> <input type="button" value="{translate key="common.cancel"}" class="button" onclick="document.location.href='{url op="tracks" escape=false}'" /></p>
