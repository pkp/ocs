...
{if $tracks->wasEmpty()}
	<tr>
		<td colspan="3" class="nodata">{translate key="director.tracks.noneCreated"}</td>
	</tr>
	<tr>
...
<a class="action" href="{url op="createTrack"}">{translate key="director.tracks.create"}</a>
