...
<table class="data" width="100%">
	...
	<tr valign="top">
		...
		<td class="value">
			<input type="checkbox" name="options[]" id="options-importSubscriptions" value="importSubscriptions"{if $options && in_array('importSubscriptions', $options)} checked="checked"{/if} /> <label for="options-importSubscriptions">{translate key="admin.conferences.importSubscriptions"}</label><br/>
