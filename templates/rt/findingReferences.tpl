 ...
 *
 * Paper reading tools -- "finding references" page.
 *
 *}
{strip}
...
function invokeGoogleScholar() {
	...
	googleScholarForm.as_q.value = inputForm.title.value;
	googleScholarForm.as_sauthors.value = inputForm.author.value;
...
function invokeWLA() {
	...
	var inputForm = document.getElementById('inputForm');
	wlaForm.q.value = inputForm.title.value + " " + inputForm.author.value;
	wlaForm.submit();
}
...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value"><input type="text" id="title" name="title" size="40" maxlength="40" class="textField" value="{$paper->getLocalizedTitle()|escape}" /></td>
	</tr>
</table>
