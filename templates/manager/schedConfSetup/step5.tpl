...
<form method="post" action="{url op="saveSchedConfSetup" path="5"}" enctype="multipart/form-data">
...
{if $alternateLocale1}
<br />
<h4>{translate key="manager.setup.conferenceTitle"} ({$languageToggleLocales.$alternateLocale1})</h4>
...
<h4>{translate key="manager.setup.conferenceLogo"} ({$languageToggleLocales.$alternateLocale1})</h4>
...
{if $alternateLocale2}
<br />
<h4>{translate key="manager.setup.conferenceTitle"} ({$languageToggleLocales.$alternateLocale2})</h4>
...
<h4>{translate key="manager.setup.conferenceLogo"} ({$languageToggleLocales.$alternateLocale2})</h4>
...
<h3>5.3 {translate key="manager.setup.conferencePageHeader"}</h3>

<p>{translate key="manager.setup.conferencePageHeaderDescription"}</p>
...
<h3>5.4 {translate key="manager.setup.conferencePageFooter"}</h3>

<p>{translate key="manager.setup.conferencePageFooterDescription"}</p>
...
<tr>
	...
	<td width="80%" class="value"><input type="file" name="schedConfStyleSheet" class="uploadField" /> <input type="submit" name="uploadConferenceStyleSheet" value="{translate key="common.upload"}" class="button" /></td>
</tr>
</table>

{if $schedConfStyleSheet}
{translate key="common.fileName"}: <a href="{$publicFilesDir}/{$schedConfStyleSheet.uploadName}" class="file">{$schedConfStyleSheet.name}</a> {$schedConfStyleSheet.dateUploaded|date_format:$datetimeFormatShort} <input type="submit" name="deleteConferenceStyleSheet" value="{translate key="common.delete"}" class="button" />
{/if}
