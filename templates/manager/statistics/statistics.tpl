...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td width="80%" colspan="2" class="value">{translate key="manager.statistics.statistics.count.value" count=$limitedPaperStatistics.submissionsAccept percentage=$limitedPaperStatistics.submissionsAcceptPercent}</label></td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td width="80%" colspan="2" class="value">{translate key="manager.statistics.statistics.count.value" count=$limitedPaperStatistics.submissionsRevise percentage=$limitedPaperStatistics.submissionsRevisePercent}</td>
	</tr>
	<tr valign="top">
