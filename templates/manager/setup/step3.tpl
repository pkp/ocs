...
<br />
<img src="{$publicConferenceFilesDir}/{$homeHeaderTitleImage.uploadName}" width="{$homeHeaderTitleImage.width}" height="{$homeHeaderTitleImage.height}" style="border: 0;" alt="" />
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$homeHeaderLogoImage.uploadName}" width="{$homeHeaderLogoImage.width}" height="{$homeHeaderLogoImage.height}" style="border: 0;" alt="" />
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$homeHeaderTitleImageAlt1.uploadName}" width="{$homeHeaderTitleImageAlt1.width}" height="{$homeHeaderTitleImageAlt1.height}" style="border: 0;" alt="" />
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$homeHeaderLogoImageAlt1.uploadName}" width="{$homeHeaderLogoImageAlt1.width}" height="{$homeHeaderLogoImageAlt1.height}" style="border: 0;" alt="" />
{/if}
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$homeHeaderTitleImageAlt2.uploadName}" width="{$homeHeaderTitleImageAlt2.width}" height="{$homeHeaderTitleImageAlt2.height}" style="border: 0;" alt="" />
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$homeHeaderLogoImageAlt2.uploadName}" width="{$homeHeaderLogoImageAlt2.width}" height="{$homeHeaderLogoImageAlt2.height}" style="border: 0;" alt="" />
{/if}
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$pageHeaderTitleImage.uploadName}" width="{$pageHeaderTitleImage.width}" height="{$pageHeaderTitleImage.height}" style="border: 0;" alt="" />
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$pageHeaderLogoImage.uploadName}" width="{$pageHeaderLogoImage.width}" height="{$pageHeaderLogoImage.height}" style="border: 0;" alt="" />
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$pageHeaderTitleImageAlt1.uploadName}" width="{$pageHeaderTitleImageAlt1.width}" height="{$pageHeaderTitleImageAlt1.height}" style="border: 0;" alt="" />
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$pageHeaderLogoImageAlt1.uploadName}" width="{$pageHeaderLogoImageAlt1.width}" height="{$pageHeaderLogoImageAlt1.height}" style="border: 0;" alt="" />
{/if}
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$pageHeaderTitleImageAlt2.uploadName}" width="{$pageHeaderTitleImageAlt2.width}" height="{$pageHeaderTitleImageAlt2.height}" style="border: 0;" alt="" />
{/if}
...
<br />
<img src="{$publicConferenceFilesDir}/{$pageHeaderLogoImageAlt2.uploadName}" width="{$pageHeaderLogoImageAlt2.width}" height="{$pageHeaderLogoImageAlt2.height}" style="border: 0;" alt="" />
{/if}
{/if}
