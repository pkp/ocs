...
<form class="pkp_form" id="setupForm" method="post" action="{url op="saveSetup" path="5"}">
...
<h3>5.1 {translate key="manager.setup.indexing.searchEngineIndexing"}</h3>
...
<h3>5.2 {translate key="manager.setup.indexing.registerConferenceForIndexing"}</h3>
