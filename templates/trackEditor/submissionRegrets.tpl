...
{translate|assign:"pageTitleTranslated" key="trackEditor.regrets.title" paperId=$submission->getPaperId()}
{assign var=pageTitleTranslated value=$pageTitleTranslated|escape}
{assign var="pageCrumbTitle" value="trackEditor.regrets.breadcrumb"}
...
{include file="trackEditor/submission/rounds.tpl"}
