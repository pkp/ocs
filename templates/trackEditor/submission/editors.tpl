...
<table width="100%" class="listing">
	...
	{/if}
		<tr valign="top">
			<td>{if $editAssignment->getIsEditor()}{translate key="user.role.editor"}{else}{translate key="user.role.trackEditor"}{/if}</td>
			<td>
...
{if $isEditor}
	...
	<a href="{url op="assignEditor" path="trackEditor" paperId=$submission->getPaperId()}" class="action">{translate key="editor.paper.assignTrackEditor"}</a>
