...
{include file="trackEditor/submission/management.tpl"}

<div class="separator"></div>

{include file="trackEditor/submission/editors.tpl"}

<div class="separator"></div>

{include file="trackEditor/submission/status.tpl"}

<div class="separator"></div>

{include file="trackEditor/submission/metadata.tpl"}
