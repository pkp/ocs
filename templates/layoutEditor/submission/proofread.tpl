...
<a href="{url op="viewMetadata" path=$proofAssignment->getPaperId()}" class="action" target="_new">{translate key="submission.reviewMetadata"}</a>
	...
	<tr>
		...
		<td>
			...
			{else}
				...
				{url|assign:"url" op="layoutEditorProofreadingComplete" paperId=$submission->getPaperId()}
