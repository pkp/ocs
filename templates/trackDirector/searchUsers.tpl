{**
 * templates/trackDirector/searchUsers.tpl
 *
...
<form class="pkp_form" id="submit" method="post" action="{url op="enrollSearch" path=$paperId}">
...
<div id="users">
<form class="pkp_form" action="{url op="enroll" path=$paperId}" method="post">
