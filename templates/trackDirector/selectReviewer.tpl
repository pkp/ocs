...
<tr class="heading" valign="bottom">
	...
	<td width="7%">{sort_search key="director.submissions.averageTime" heading="average"}</td>
	<td width="13%">{sort_search key="director.submissions.lastAssigned" heading="latest"}</td>
