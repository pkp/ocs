...
<h3>{translate key="editor.paper.designateDueDate"}</h3>

<p>{translate key="editor.paper.designateDueDateDescription"}</p>

<form method="post" action="{url op=$actionHandler path=$paperId|to_array:$reviewId}">
	<table class="data" width="100%">
		<tr valign="top">
			<td class="label" width="20%">{translate key="editor.paper.todaysDate"}</td>
			<td class="value" width="80%">{$todaysDate|escape}</td>
		</tr>
		<tr valign="top">
			<td class="label">{translate key="editor.paper.requestedByDate"}</td>
			<td class="value">
				...
				<span class="instruct">{translate key="editor.paper.dueDateFormat"}</span>
			</td>
		</tr>
		<tr valign="top">
			<td>&nbsp;</td>
		...
		<tr valign="top">
			<td class="label">{translate key="editor.paper.numberOfWeeks"}</td>
