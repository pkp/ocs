...
<a class="action" href="javascript:openHelp('{get_help_id key="editorial.trackEditorsRole.review.blindPeerReview" url="true"}')">{translate key="reviewer.paper.ensuringBlindReview"}</a></p>
