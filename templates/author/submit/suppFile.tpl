...
<tr valign="top">
	...
	<td width="80%" class="value"><textarea name="description[{$formLocale|escape}]" class="textArea richContent" id="description" rows="5" cols="60">{$description[$formLocale]|escape}</textarea></td>
</tr>
<tr valign="top">
