...
<br />
{$eventSettings.privacyStatement|nl2br}
...
{if $track->getMetaIndexed()==1}
	...
	<tr valign="top">
		<td{if $eventSettings.metaDisciplineExamples} rowspan="2"{/if} width="20%" class="label">{fieldLabel name="discipline" key="paper.discipline"}</td>
	...
	{if $eventSettings.metaDisciplineExamples}
	<tr valign="top">
		<td><span class="instruct">{$eventSettings.metaDisciplineExamples|escape}</span></td>
	</tr>
	{/if}
	<tr valign="top">
		<td>&nbsp;</td>
	...
	<tr valign="top">
		<td width="20%" class="label"><a href="{$eventSettings.metaSubjectClassUrl|escape}" target="_blank">{$eventSettings.metaSubjectClassTitle|escape}</a></td>
	</tr>
	<tr valign="top">
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr valign="top">
		<td{if $eventSettings.metaSubjectExamples} rowspan="2"{/if} width="20%" class="label">{fieldLabel name="subject" key="paper.subject"}</td>
	...
	{if $eventSettings.metaSubjectExamples}
	<tr valign="top">
		<td><span class="instruct">{$eventSettings.metaSubjectExamples|escape}</span></td>
	</tr>
	{/if}
	<tr valign="top">
		<td>&nbsp;</td>
	...
	<tr valign="top">
		<td{if $eventSettings.metaCoverageGeoExamples} rowspan="2"{/if} width="20%" class="label">{fieldLabel name="coverageGeo" key="paper.coverageGeo"}</td>
	...
	{if $eventSettings.metaCoverageGeoExamples}
	<tr valign="top">
		<td><span class="instruct">{$eventSettings.metaCoverageGeoExamples|escape}</span></td>
	</tr>
	{/if}
	<tr valign="top">
		<td>&nbsp;</td>
	...
	<tr valign="top">
		<td{if $eventSettings.metaCoverageChronExamples} rowspan="2"{/if} width="20%" class="label">{fieldLabel name="coverageChron" key="paper.coverageChron"}</td>
	...
	{if $eventSettings.metaCoverageChronExamples}
	<tr valign="top">
		<td><span class="instruct">{$eventSettings.metaCoverageChronExamples|escape}</span></td>
	</tr>
	{/if}
	<tr valign="top">
		<td>&nbsp;</td>
	...
	<tr valign="top">
		<td{if $eventSettings.metaCoverageResearchSampleExamples} rowspan="2"{/if} width="20%" class="label">{fieldLabel name="coverageSample" key="paper.coverageSample"}</td>
	...
	{if $eventSettings.metaCoverageResearchSampleExamples}
	<tr valign="top">
		<td><span class="instruct">{$eventSettings.metaCoverageResearchSampleExamples|escape}</span></td>
	</tr>
	{/if}
	<tr valign="top">
		<td>&nbsp;</td>
	...
	<tr valign="top">
		<td width="20%" {if $eventSettings.metaTypeExamples}rowspan="2" {/if}class="label">{fieldLabel name="type" key="paper.type"}</td>
		<td width="80%" class="value"><input type="text" class="textField" name="type" id="type" value="{$type|escape}" size="40" maxlength="255" /></td>
	</tr>

	{if $eventSettings.metaTypeExamples}
	<tr valign="top">
		<td><span class="instruct">{$eventSettings.metaTypeExamples|escape}</span></td>
	</tr>
	{/if}
	<tr valign="top">
		<td>&nbsp;</td>
