...
<p>{translate key="author.submit.uploadInstructions" supportName=$eventSettings.supportName supportEmail=$eventSettings.supportEmail supportPhone=$eventSettings.supportPhone}<br/>
