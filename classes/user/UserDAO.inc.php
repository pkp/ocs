	...
	function insertUser(&$user) {
		...
		$this->update(
			sprintf('INSERT INTO users
				(username, signature, password, first_name, middle_name, initials, last_name, affiliation, email, url, phone, fax, mailing_address, country, time_zone, biography, interests, locales, date_last_email, date_registered, date_last_login, must_change_password, disabled, disabled_reason, auth_id)
				VALUES
				(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, %s, %s, %s, ?, ?, ?, ?)',
