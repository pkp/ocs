...
class LanguageSettingsForm extends Form {
	...
	function LanguageSettingsForm() {
		parent::Form('director/languageSettings.tpl');
		...
		$this->addCheck(new FormValidator($this, 'primaryLocale', 'required', 'director.languages.form.primaryLocaleRequired'), array('Locale', 'isLocaleValid'));
		$this->addCheck(new FormValidator($this, 'primaryLocale', 'required', 'director.languages.form.primaryLocaleRequired'), $localeCheck, array(&$this->availableLocales));
		$this->addCheck(new FormValidator($this, 'alternateLocale1', 'optional', 'director.languages.form.alternateLocale1Invalid'), array('Locale', 'isLocaleValid'));
		$this->addCheck(new FormValidator($this, 'alternateLocale1', 'optional', 'director.languages.form.alternateLocale1Invalid'), $localeCheck, array(&$this->availableLocales));
		$this->addCheck(new FormValidator($this, 'alternateLocale2', 'optional', 'director.languages.form.alternateLocale2Invalid'), array('Locale', 'isLocaleValid'));
		$this->addCheck(new FormValidator($this, 'alternateLocale2', 'optional', 'director.languages.form.alternateLocale2Invalid'), $localeCheck, array(&$this->availableLocales));
	}
